 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2023-DEC-02  10:30:58 AM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Announce1");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			...
			IProjectVariables.ENTER_MOBILE_NUM_FIELD_INPUTMODE,
			IProjectVariables.ENTER_MOBILE_NUM_FIELD_INTERPRETATION,
			IProjectVariables.ENTER_MOBILE_NUM_FIELD_NOINPUTCOUNT,
			IProjectVariables.ENTER_MOBILE_NUM_FIELD_NOMATCHCOUNT,
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.UC_ID, "785678", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.ENTER_ID_FIELD_CONFIDENCE,
			IProjectVariables.ENTER_ID_FIELD_INPUTMODE,
			IProjectVariables.ENTER_ID_FIELD_INTERPRETATION,
			IProjectVariables.ENTER_ID_FIELD_NOINPUTCOUNT,
			IProjectVariables.ENTER_ID_FIELD_NOMATCHCOUNT,
			IProjectVariables.ENTER_ID_FIELD_UTTERANCE,
			IProjectVariables.ENTER_ID_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.ENTER_ID, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.MOBILE_NUMBER, "", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.END_TIME, "", null, session, false, false );
		session.putVariable(variable);
	 ...
	 * Last generated by Orchestration Designer at: 2023-DEC-02  04:47:53 PM
	 */
