 ...
 * Last generated by Orchestration Designer at: 2023-NOV-17  05:47:13 PM
 */
public class Main_Menu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("NI", ""));
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("NM", ""));
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("one", "1", true, "exact", "Announce2", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Two", "2", true, "exact", "Announce3", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("MainManu", ""));
