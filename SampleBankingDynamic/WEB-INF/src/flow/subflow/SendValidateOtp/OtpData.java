 ...
 * Last generated by Orchestration Designer at: 2024-JAN-06  11:24:56 AM
 */
public class OtpData extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("SendValidateOtp-EntOpt", "Default");
		next.setDebugId(304);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		 ...
		 try {
			    ...
			    String sV = mySession.getVariableField(IProjectVariables.AF).getStringValue();
			    if(sV.equals("PC")) {
			    	file = mySession.getServlet().getServletContext().getInitParameter("ChangeAtmPin");
			    }else {
			    	 file = mySession.getServlet().getServletContext().getInitParameter("SampleBankDynamic");
			    }
