...
public class SendOptApi extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
      ...
      try {
			...
			URL url = new URL(otpUrl+"/send?mobileNumber="+mobileNumber);
...
//				}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "responseCode", com.avaya.sce.runtime.Expression.STRING_EQUAL, "201", false).setDebugId(180)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("SendValidateOtp-ResetFCnt", "success").setDebugId(181));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
