...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			...
			IProjectVariables.USER_STORE_FIELD_MAX_TRY,
			IProjectVariables.USER_STORE_FIELD_MENU_DES,
			IProjectVariables.USER_STORE_FIELD_NEXTKEYWORD,
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NI_COUNT, "0", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_CONFIDENCE,
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_INPUTMODE,
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_INTERPRETATION,
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_NOINPUTCOUNT,
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_NOMATCHCOUNT,
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_UTTERANCE,
			IProjectVariables.PROMPT_AND_COLLECT_1_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PROMPT_AND_COLLECT_1, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NM_COUNT, "0", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.PROMPT_FIELD_ISSUE,
			IProjectVariables.PROMPT_FIELD_OTHER,
			...
			IProjectVariables.PROMPT_FIELD_SALE,
			IProjectVariables.PROMPT_FIELD_SUPPORT,
			IProjectVariables.PROMPT_FIELD_WELCOME };
