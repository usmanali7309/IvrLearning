 ...
 * Last generated by Orchestration Designer at: 2023-DEC-27  03:26:20 PM
 */
public class MainMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("press1", "1", true, "exact", "CheckAccountBal", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("press2", "2", true, "exact", "PinChange", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("press3", "3", true, "exact", "changeLang", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("press9", "9", true, "exact", "AT", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("press*", "*", true, "exact", "MainMenu", grammarInfo, true);
		list.add(choice);
