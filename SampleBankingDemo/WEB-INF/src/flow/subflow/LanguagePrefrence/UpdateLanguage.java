...
public class UpdateLanguage extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "responseCode", com.avaya.sce.runtime.Expression.STRING_EQUAL, "201", false).setDebugId(103)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("LanguagePrefrence-ResetFCnt2", "success").setDebugId(98));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("LanguagePrefrence-CheckFCount", "failure").setDebugId(105));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
