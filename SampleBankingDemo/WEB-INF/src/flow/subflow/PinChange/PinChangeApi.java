...
public class PinChangeApi extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		String cardNumber = mySession.getVariableField(IProjectVariables.ENTER_CARD_NUM,IProjectVariables.ENTER_CARD_NUM_FIELD_VALUE).getStringValue();
		...
		String confirmPin = mySession.getVariableField(IProjectVariables.ENT_COMFIRM_PIN,IProjectVariables.ENT_COMFIRM_PIN_FIELD_VALUE).getStringValue();
		...
		String pinUrl = mySession.getVariableField(IProjectVariables.PIN).getStringValue();
		
		try {
			
			URL url = new URL(pinUrl+cardNumber+"/"+cvv);
			
//			URL url = new URL("http://localhost:7080/api/atm/"+cardNumber+"/"+cvv);
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("PinChange-ApiR", 0, true, "Default");
		list.add(aGoto);
