...
import flow.subflow.AccountBalance.BankAccounts;
...
public class FetchRegisterNum extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
        ...
        try {
	     ...
	     url = new URL("http://localhost:7080/api/atm/"+cardNumber+"/"+cvv);
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("PinChange-ApiFl", 0, true, "Default");
		list.add(aGoto);
