...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("ReadPropertyFile");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MENU_FOR_VALID_FIELD_CONFIDENCE,
			IProjectVariables.MENU_FOR_VALID_FIELD_INPUTMODE,
			IProjectVariables.MENU_FOR_VALID_FIELD_INTERPRETATION,
			IProjectVariables.MENU_FOR_VALID_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_FOR_VALID_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_FOR_VALID_FIELD_UTTERANCE,
			IProjectVariables.MENU_FOR_VALID_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_FOR_VALID, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NICOUNT, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.COUNT, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NINM, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CUSTOM_TTNUM, "12345", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.WS_1VARIABLES_FIELD_ID,
			IProjectVariables.WS_1VARIABLES_FIELD_LOGIN,
			IProjectVariables.WS_1VARIABLES_FIELD_NAME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.WS_1VARIABLES, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_CONFIDENCE,
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_INPUTMODE,
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_INTERPRETATION,
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_UTTERANCE,
			IProjectVariables.MENU_FOR_NOT_VALID_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_FOR_NOT_VALID, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PROPETY_VARIABLE_FIELD_NO_INPUT,
			IProjectVariables.PROPETY_VARIABLE_FIELD_NO_MATCH };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PROPETY_VARIABLE, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.TTFETCH_FIELD_ID,
			IProjectVariables.TTFETCH_FIELD_LOGIN,
			IProjectVariables.TTFETCH_FIELD_NAME,
			IProjectVariables.TTFETCH_FIELD_RESPONSE_CODE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.TTFETCH, variableFields, null, session, false, false );
		session.putVariable(variable);
