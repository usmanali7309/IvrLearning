 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2023-NOV-20  12:23:35 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2023-NOV-21  01:29:06 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("PromptAndCollect1");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.DB_DATA_FIELD_EMAIL,
			IProjectVariables.DB_DATA_FIELD_EMP_ID,
			IProjectVariables.DB_DATA_FIELD_NAME,
			IProjectVariables.DB_DATA_FIELD_PHONE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.DB_DATA, variableFields, null, session, false, false );
		session.putVariable(variable);
