 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2023-NOV-23  02:56:20 PM
 */
public class PhraseSet1 extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: EnterEmp_Id
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "EnterEmp_Id", "EnterEmp_Id.wav", ""); 

		// phrase: EmpName
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "EmpName", "EmpName.wav", ""); 

		// phrase: EmpEmail
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "EmpEmail", "EmpEmail.wav", ""); 

		// phrase: EmpPhone
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "EmpPhone", "EmpPhone.wav", ""); 

		// phrase: EmpNotExist
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "EmpNotExist", "EmpIdNotExist.wav", ""); 
