 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2023-NOV-23  02:53:39 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2023-NOV-28  07:03:30 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Greet");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NINM, "NI", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.MAX_TRY, "3", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.INSERT_LOG_FIELD_ANI,
			IProjectVariables.INSERT_LOG_FIELD_DNIS,
			IProjectVariables.INSERT_LOG_FIELD_INPUT,
			IProjectVariables.INSERT_LOG_FIELD_SESSION_ID,
			IProjectVariables.INSERT_LOG_FIELD_TIME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.INSERT_LOG, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.ENTER_EMP_ID_FIELD_CONFIDENCE,
			IProjectVariables.ENTER_EMP_ID_FIELD_INPUTMODE,
			IProjectVariables.ENTER_EMP_ID_FIELD_INTERPRETATION,
			IProjectVariables.ENTER_EMP_ID_FIELD_NOINPUTCOUNT,
			IProjectVariables.ENTER_EMP_ID_FIELD_NOMATCHCOUNT,
			IProjectVariables.ENTER_EMP_ID_FIELD_UTTERANCE,
			IProjectVariables.ENTER_EMP_ID_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.ENTER_EMP_ID, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.UPDATE_D_FIELD_EMAIL,
			IProjectVariables.UPDATE_D_FIELD_EMP_ID,
			IProjectVariables.UPDATE_D_FIELD_NAME,
			IProjectVariables.UPDATE_D_FIELD_PHONE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.UPDATE_D, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.EQ_FIELD_EMP_ID,
			IProjectVariables.EQ_FIELD_PHONE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.EQ, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.DB_1_FIELD_EMAIL,
			IProjectVariables.DB_1_FIELD_EMP_ID,
			IProjectVariables.DB_1_FIELD_NAME,
			IProjectVariables.DB_1_FIELD_PHONE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.DB_1, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.USER_INPUTS_FIELD_INPUT };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.USER_INPUTS, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.ENTER_MOBILE_N_FIELD_CONFIDENCE,
			IProjectVariables.ENTER_MOBILE_N_FIELD_INPUTMODE,
			IProjectVariables.ENTER_MOBILE_N_FIELD_INTERPRETATION,
			IProjectVariables.ENTER_MOBILE_N_FIELD_NOINPUTCOUNT,
			IProjectVariables.ENTER_MOBILE_N_FIELD_NOMATCHCOUNT,
			IProjectVariables.ENTER_MOBILE_N_FIELD_UTTERANCE,
			IProjectVariables.ENTER_MOBILE_N_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.ENTER_MOBILE_N, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.UPDATE_DB_FIELD_EMP_ID,
			IProjectVariables.UPDATE_DB_FIELD_PHONE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.UPDATE_DB, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.DNIS_TEST, "8976546278", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SESSION_ID, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ANI_TEST, "9876362734", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TIME_STAMP, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.LOGS_DATA_FIELD_ANI,
			IProjectVariables.LOGS_DATA_FIELD_DATE,
			IProjectVariables.LOGS_DATA_FIELD_DNIS,
			IProjectVariables.LOGS_DATA_FIELD_SESSION_ID,
			IProjectVariables.LOGS_DATA_FIELD_TIME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.LOGS_DATA, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NOT_EXIST_COUNT, "0", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MENU_1_FIELD_CONFIDENCE,
			IProjectVariables.MENU_1_FIELD_INPUTMODE,
			IProjectVariables.MENU_1_FIELD_INTERPRETATION,
			IProjectVariables.MENU_1_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_1_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_1_FIELD_UTTERANCE,
			IProjectVariables.MENU_1_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_1, variableFields, null, session, false, false );
		session.putVariable(variable);
