...
public interface IProjectVariables {
	...
	public static final String ENTER_EMP_ID = "EnterEmpId";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String UPDATE_D = "UpdateD";
	public static final String SESSION = "session";
	public static final String EQ = "Eq";
	public static final String DB_1 = "Db1";
	public static final String USER_INPUTS = "UserInputs";
	public static final String ENTER_MOBILE_N = "EnterMobileN";
	public static final String UPDATE_DB = "UpdateDb";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String DNIS_TEST = "dnisTest";
	public static final String SESSION_ID = "sessionId";
	public static final String ANI_TEST = "aniTest";
	public static final String TIME_STAMP = "timeStamp";
	public static final String LOGS_DATA = "logsData";
	public static final String NOT_EXIST_COUNT = "NotExistCount";
	...
	public static final String INSERT_LOG_FIELD_ANI = "ani";
	public static final String INSERT_LOG_FIELD_DNIS = "dnis";
	public static final String INSERT_LOG_FIELD_INPUT = "input";
	public static final String INSERT_LOG_FIELD_SESSION_ID = "sessionId";
	public static final String INSERT_LOG_FIELD_TIME = "time";
	public static final String ENTER_EMP_ID_FIELD_CONFIDENCE = "confidence";
	public static final String ENTER_EMP_ID_FIELD_INPUTMODE = "inputmode";
	public static final String ENTER_EMP_ID_FIELD_INTERPRETATION = "interpretation";
	public static final String ENTER_EMP_ID_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String ENTER_EMP_ID_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String ENTER_EMP_ID_FIELD_UTTERANCE = "utterance";
	public static final String ENTER_EMP_ID_FIELD_VALUE = "value";
	...
	public static final String UPDATE_D_FIELD_EMAIL = "Email";
	public static final String UPDATE_D_FIELD_EMP_ID = "empId";
	public static final String UPDATE_D_FIELD_NAME = "Name";
	public static final String UPDATE_D_FIELD_PHONE = "Phone";
	...
	public static final String EQ_FIELD_EMP_ID = "empId";
	public static final String EQ_FIELD_PHONE = "Phone";
	public static final String DB_1_FIELD_EMAIL = "Email";
	public static final String DB_1_FIELD_EMP_ID = "empId";
	public static final String DB_1_FIELD_NAME = "Name";
	public static final String DB_1_FIELD_PHONE = "Phone";
	public static final String USER_INPUTS_FIELD_INPUT = "input";
	public static final String ENTER_MOBILE_N_FIELD_CONFIDENCE = "confidence";
	public static final String ENTER_MOBILE_N_FIELD_INPUTMODE = "inputmode";
	public static final String ENTER_MOBILE_N_FIELD_INTERPRETATION = "interpretation";
	public static final String ENTER_MOBILE_N_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String ENTER_MOBILE_N_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String ENTER_MOBILE_N_FIELD_UTTERANCE = "utterance";
	public static final String ENTER_MOBILE_N_FIELD_VALUE = "value";
	public static final String UPDATE_DB_FIELD_EMP_ID = "empId";
	public static final String UPDATE_DB_FIELD_PHONE = "Phone";
	...
	public static final String LOGS_DATA_FIELD_ANI = "ani";
	public static final String LOGS_DATA_FIELD_DATE = "date";
	public static final String LOGS_DATA_FIELD_DNIS = "dnis";
	public static final String LOGS_DATA_FIELD_SESSION_ID = "sessionId";
	public static final String LOGS_DATA_FIELD_TIME = "time";
	...
	public static final String MENU_1_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_1_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_1_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_1_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_1_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_1_FIELD_UTTERANCE = "utterance";
	public static final String MENU_1_FIELD_VALUE = "value";
