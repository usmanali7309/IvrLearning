 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2023-NOV-17  06:18:12 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2023-NOV-21  02:52:29 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("ReadProps");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.RESULT, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TEST, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.RETRY, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.FIRST_NUM_FIELD_CONFIDENCE,
			IProjectVariables.FIRST_NUM_FIELD_INPUTMODE,
			IProjectVariables.FIRST_NUM_FIELD_INTERPRETATION,
			IProjectVariables.FIRST_NUM_FIELD_NOINPUTCOUNT,
			IProjectVariables.FIRST_NUM_FIELD_NOMATCHCOUNT,
			IProjectVariables.FIRST_NUM_FIELD_UTTERANCE,
			IProjectVariables.FIRST_NUM_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.FIRST_NUM, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.PROPERTVARIABLE_FIELD_MAX_TRIES,
			IProjectVariables.PROPERTVARIABLE_FIELD_NOINPUT,
			IProjectVariables.PROPERTVARIABLE_FIELD_NO_MATCH };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PROPERTVARIABLE, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.SECOND_NUM_FIELD_CONFIDENCE,
			IProjectVariables.SECOND_NUM_FIELD_INPUTMODE,
			IProjectVariables.SECOND_NUM_FIELD_INTERPRETATION,
			IProjectVariables.SECOND_NUM_FIELD_NOINPUTCOUNT,
			IProjectVariables.SECOND_NUM_FIELD_NOMATCHCOUNT,
			IProjectVariables.SECOND_NUM_FIELD_UTTERANCE,
			IProjectVariables.SECOND_NUM_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.SECOND_NUM, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ATTEMPT__NI, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ATTEMPT__NM, "", null, session, false, false );
		session.putVariable(variable);
