 ...
 * Last generated by Orchestration Designer at: 2023-NOV-17  06:48:36 PM
 */
public class SecondNum extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("SecondNum", ""));
		...
		// build events for the field: "SecondNum"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("SecondNum", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Menu1");
		return submit;
	}
	/**
