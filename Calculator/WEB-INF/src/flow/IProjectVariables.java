...
public interface IProjectVariables {
	...
	public static final String PROPERTVARIABLE = "Propertvariable";
	public static final String SECOND_NUM = "SecondNum";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String ATTEMPT__NI = "Attempt_NI";
	public static final String ATTEMPT__NM = "Attempt_NM";
	...
	public static final String FIRST_NUM_FIELD_CONFIDENCE = "confidence";
	public static final String FIRST_NUM_FIELD_INPUTMODE = "inputmode";
	public static final String FIRST_NUM_FIELD_INTERPRETATION = "interpretation";
	public static final String FIRST_NUM_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String FIRST_NUM_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String FIRST_NUM_FIELD_UTTERANCE = "utterance";
	public static final String FIRST_NUM_FIELD_VALUE = "value";
	...
	public static final String PROPERTVARIABLE_FIELD_MAX_TRIES = "MaxTries";
	public static final String PROPERTVARIABLE_FIELD_NOINPUT = "Noinput";
	public static final String PROPERTVARIABLE_FIELD_NO_MATCH = "NoMatch";
	public static final String SECOND_NUM_FIELD_CONFIDENCE = "confidence";
	public static final String SECOND_NUM_FIELD_INPUTMODE = "inputmode";
	public static final String SECOND_NUM_FIELD_INTERPRETATION = "interpretation";
	public static final String SECOND_NUM_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SECOND_NUM_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SECOND_NUM_FIELD_UTTERANCE = "utterance";
	public static final String SECOND_NUM_FIELD_VALUE = "value";
